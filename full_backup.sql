...
\restrict 2Qi2yirIg44K2Is3k6CerIDrO2fU1xr7mbxd32CPKgHh3cMsRmo7cDVDKIRicVC
...
COPY public.businesses (id, category_id, owner_name, business_name, description, phone, address, instagram, facebook, created_at, updated_at, location_id) FROM stdin;
2	1	ilham	aren gula	ilham	0990099990	dskasdkdask	\N	\N	2026-07-13 20:41:20.419611	2026-07-13 20:41:20.419611	\N
\.
...
COPY public.categories (id, name, slug, type, created_at, updated_at) FROM stdin;
1	Dashboard	dashboard	dashboard	2026-07-04 11:40:35.863008	2026-07-04 11:40:35.863008
2	Pendidikan	pendidikan	news	2026-07-09 00:21:26.60145	2026-07-09 00:21:26.60145
3	Kuliner	kuliner	business	2026-07-10 17:34:32.745891	2026-07-10 17:34:32.745891
11	Galeri	galeri	gallery	2026-07-20 16:32:39.906825	2026-07-20 16:32:39.906825
\.
...
COPY public.documents (id, category_id, uploaded_by, title, description, created_at, media_id, updated_at, source) FROM stdin;
4	2	6	ilham	12133113	2026-07-12 21:40:20.639767	\N	2026-07-12 21:40:20.639767	\N
5	1	5	ilham	dakasdksadk	2026-07-13 22:46:45.748125	\N	2026-07-13 22:46:45.748125	\N
7	2	6	dasdas	dsadsa	2026-07-20 16:34:58.170009	21	2026-07-20 16:34:58.170009	\N
\.
...
COPY public.events (id, author_id, title, slug, description, location, start_date, end_date, status, created_at, updated_at, category_id) FROM stdin;
\.
...
COPY public.galleries (id, created_by, title, description, created_at, category_id, media_id, updated_at, is_active) FROM stdin;
1	5	dashboard	dashboard2	2026-07-04 13:34:57.553767	1	\N	2026-07-20 11:55:37.138943	f
2	5	dashboard	dashboard2	2026-07-04 13:41:08.130782	1	15	2026-07-20 15:32:28.514496	t
7	6	dsakasdkdsa	dsaksaksadkdsa	2026-07-20 16:33:22.892896	11	20	2026-07-20 16:33:22.892896	f
\.
...
COPY public.locations (id, latitude, longitude, created_by_id, title, description, created_at, updated_at) FROM stdin;
\.
...
COPY public.media (id, uploaded_by, entity_type, entity_id, role, original_name, file_name, file_path, mime_type, file_size, caption, order_number, created_at, updated_at) FROM stdin;
15	6	dashboard	2	image	\N	\N	uploads/dashboard/1784536348514020947.png	image/png	\N	\N	0	2026-07-20 15:32:28.514496	2026-07-20 15:32:28.514496
20	6	gallery	7	image	\N	\N	uploads/gallery/1784540002891569326.png	image/png	\N	\N	0	2026-07-20 16:33:22.892896	2026-07-20 16:33:22.892896
21	6	news	7	image	\N	\N	uploads/news/1784540098169274813.png	image/png	\N	\N	0	2026-07-20 16:34:58.170009	2026-07-20 16:34:58.170009
\.
...
COPY public.officials (id, village_id, name, "position", phone, email, description, order_number, is_active, created_at, updated_at, start_date, finish_date) FROM stdin;
\.
...
COPY public.posts (id, category_id, author_id, type, title, slug, excerpt, content, publish_start, publish_end, is_pinned, status, views, created_at, updated_at) FROM stdin;
\.
...
COPY public.potential_detail (title, detail, description, id) FROM stdin;
\.
...
COPY public.potentials (id, title, subtitle, description, owner_name, owner_msisdn, category_id, slug, media_id, location_id, created_at, updated_at) FROM stdin;
1	ilham	ilhamm	sdkaskasd	ilham	121122112	1	ilham	\N	\N	2026-07-14 21:52:27.089467	2026-07-14 21:52:27.089467
2	ilham	ilhamm	sdkaskasd	ilham	121122112	1	ilham	\N	\N	2026-07-14 21:52:50.540365	2026-07-14 21:52:50.540365
\.
...
COPY public.users (id, role, password, is_active, last_login, created_at, updated_at, username, name) FROM stdin;
5	admin	$2a$10$vM7LYExPv2CNvn9kMilcC.0ov2UH3ZhXAQ/SPV790bg.aBMZY554a	t	2026-07-14 19:59:23.103474	2026-07-04 10:57:40.252264	2026-07-04 10:57:40.252264	ilhamgod14	ilham
6	admin	$2a$10$dKemcSEvrqE4Q2k2Y7XKzeP1VqtnTW8amqfUAV.MvmN3Z.QRiEaSO	t	2026-07-17 21:23:08.349048	2026-07-10 17:00:38.372401	2026-07-17 21:23:08.349048	roby	ilham
\.
...
COPY public.villages (id, name, province, regency, district, postal_code, address, phone, email, website, latitude, longitude, vision, history, description, created_at, updated_at, village_code, total_population, total_family, title, wide, mission, elevation, coordinate, population, region, hamlet_one, hamlet_two, north_border, east_border, south_border, west_border, area, is_active) FROM stdin;
\.
...
\unrestrict 2Qi2yirIg44K2Is3k6CerIDrO2fU1xr7mbxd32CPKgHh3cMsRmo7cDVDKIRicVC
